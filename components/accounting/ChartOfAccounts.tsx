...
const INDUSTRY_TEMPLATES: Record<string, { label: string; description: string; vatSchemes: string[]; accounts: TemplateAccount[] }> = {
  general: {
    ...
    accounts: [
      ...
      { code: '4100', name: 'Other Income', account_type: 'other_income' },
      { code: '4101', name: 'Bank Interest Received', account_type: 'other_income', vatCode: 'no_vat', parentCode: '4100' },
      { code: '4102', name: 'Grant Income', account_type: 'other_income', vatCode: 'no_vat', parentCode: '4100' },
  ...
  property: {
    ...
    accounts: [
      ...
      { code: '4200', name: 'Other Income', account_type: 'other_income' },
      { code: '4201', name: 'Bank Interest Received', account_type: 'other_income', vatCode: 'no_vat', parentCode: '4200' },
      { code: '4202', name: 'Grant Income', account_type: 'other_income', vatCode: 'no_vat', parentCode: '4200' },
