...
export default function NoteReply({ noteId, clientId, firmId, currentUserId, onReplyAdded }: Props) {
  ...
  if (!showing) {
    return (
      <button
        ...
        className="text-xs text-brand-gold hover:text-brand-dark transition font-medium"
      >
        ↩ Reply
      </button>
    )
  ...
  return (
    <div className="mt-3 space-y-2">
      ...
      <div className="flex gap-2">
        ...
        <button
          onClick={() => { setShowing(false); setContent('') }}
