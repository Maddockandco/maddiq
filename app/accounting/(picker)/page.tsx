          ...
          {loading ? (
            ...
            <div className="bg-white rounded-2xl shadow-sm p-12 text-center border border-gray-200">
              <p className="text-gray-500 text-sm mb-1">
                {search ? 'No clients match your search' : 'No clients are signed up to accounting yet'}
              </p>
              {!search && (
                <p className="text-gray-400 text-xs">
                  Add a client to accounting from their Overview or Edit page in the Clients section.
                </p>
              )}
            </div>
          ) : (
