        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-5 h-full">
          <div className="flex items-center justify-between mb-3">
            <div className="flex items-center gap-2 min-w-0">
              ...
              {bank.connectionStatus === 'not_connected' && (
                <span className="text-xs px-2 py-0.5 rounded-full font-medium bg-gray-100 text-gray-500 flex-shrink-0">Not Connected</span>
              )}
            </div>
          ...
          {bank.connectionStatus === 'not_connected' && (
            <div className="bg-gray-50 rounded-lg px-3 py-2 mb-3">
              <div className="flex items-center justify-between">
                <p className="text-xs text-gray-500">Not connected to Open Banking yet</p>
                <button
                  onClick={() => router.push(`/accounting/${params.clientId}/bank-transactions?account=${bank.id}&auto_connect=1`)}
                  className="text-xs bg-brand-dark text-white font-semibold px-3 py-1.5 rounded-lg hover:bg-opacity-90 transition flex-shrink-0 ml-2"
                >
                  Connect
                </button>
              </div>
