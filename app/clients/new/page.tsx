          ...
          {!existingClientId && (
            <>
              ...
              {type === 'partnership' && (
                <>
                  <div>
                    <label className="block text-sm font-medium text-brand-dark mb-2">Partnership type</label>
                    <div className="flex gap-3">
                      {[
                        ...
                        <button key={t.value} onClick={() => setPartnershipType(t.value)}
                          className={`px-3 py-1.5 rounded-lg text-xs font-medium transition ${
                            partnershipType === t.value ? 'bg-brand-dark text-white' : 'bg-gray-100 text-gray-600 hover:bg-gray-200'
                          }`}
                        >
                          {t.label}
                        </button>
                  ...
                  <div>
                    <label className="block text-sm font-medium text-brand-dark mb-1">Partnership UTR</label>
                    <input type="text" value={partnershipUtr} onChange={(e) => setPartnershipUtr(e.target.value)}
                  ...
                  {partnershipType === 'llp' && (
                    <div>
                      <label className="block text-sm font-medium text-brand-dark mb-1">Companies House number</label>
                      <input type="text" value={companyNumber} onChange={(e) => setCompanyNumber(e.target.value)}
                        placeholder="OC123456" className={inputClass} />
                    </div>
                  )}
                  <div>
                    <label className="block text-sm font-medium text-brand-dark mb-1">Year end date</label>
